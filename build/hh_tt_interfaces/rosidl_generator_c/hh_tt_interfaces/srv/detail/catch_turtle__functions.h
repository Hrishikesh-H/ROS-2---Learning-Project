...
#ifndef HH_TT_INTERFACES__SRV__DETAIL__CATCH_TURTLE__FUNCTIONS_H_
#define HH_TT_INTERFACES__SRV__DETAIL__CATCH_TURTLE__FUNCTIONS_H_
...
#include "hh_tt_interfaces/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_hh_tt_interfaces
bool
 ...
 * calls
 * hh_tt_interfaces__srv__CatchTurtle_Request__init().
...
/**
 * It calls
 * hh_tt_interfaces__srv__CatchTurtle_Request__fini()
 ...
 * hh_tt_interfaces__srv__CatchTurtle_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * hh_tt_interfaces__srv__CatchTurtle_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hh_tt_interfaces__srv__CatchTurtle_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hh_tt_interfaces
...
/**
 * It calls
 * hh_tt_interfaces__srv__CatchTurtle_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_hh_tt_interfaces
...
/**
 * It allocates the memory for the array and calls
 * hh_tt_interfaces__srv__CatchTurtle_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hh_tt_interfaces
...
/**
 * It calls
 * hh_tt_interfaces__srv__CatchTurtle_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // HH_TT_INTERFACES__SRV__DETAIL__CATCH_TURTLE__FUNCTIONS_H_
